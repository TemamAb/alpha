...
def fetch_liquidity(chain, token):
    ...
    try:
        ...
        # Fallback to estimated values if RPC call fails
        print(f"[LIQUIDITY] Using estimated values for {token} on {chain}")
        liquidity_map = {
            'ethereum': {'USDC': 5000000, 'DAI': 3000000, 'USDT': 4000000, 'WETH': 15000000},
            'polygon': {'USDC': 2000000, 'WMATIC': 500000, 'USDT': 1500000},
            'bsc': {'USDC': 3000000, 'WBNB': 2000000, 'USDT': 2500000},
            'arbitrum': {'USDC': 4000000, 'WETH': 12000000, 'USDT': 3000000},
            'optimism': {'USDC': 2500000, 'WETH': 8000000, 'USDT': 2000000}
        }
        
        return liquidity_map.get(chain, {}).get(token, 100000.0)
